    ...
    try:
        ...
        for keyword in keywords:
            if keyword in page_text:
                ...
                return f"Keyword '{keyword}' Found - Working", "Working"
        
        return "Keyword Not Found - Not Working", "Not Working"
    except Exception:
        return "Unknown Error", "Not Working"
...
for website in websites:
    ...
    final_status = "Working" if "Working" in [first_status, retry_status] else "Not Working"
...
detailed_output = "website_status_detailed_c2.xlsx"
df_detailed = pd.DataFrame(results, columns=["Website URL", "First Check Error Code", "First Check Status", "Retry Error Code", "Retry Status", "Final Status"])
df_detailed.to_excel(detailed_output, index=False)

summary_output = "website_status_summary_c2.xlsx"
